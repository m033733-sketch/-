...
const conciergeKB = [
  {
    ...
    quick: 'Сколько стоит?',
    answer: 'Один домик — 6 000 ₽ за сутки (до 6 человек). Оба домика — 12 000 ₽ за сутки (до 12 человек). Баня — 2 000 ₽ за час, бронируется отдельно. Все цены без скрытых доплат, заезд с 14:00, выезд до 12:00.'
  },
  {
    id: 'included',
  ...
  },
  {
    ...
    answer: 'Баня бронируется отдельно — 2 000 ₽ за час, минимум 2 часа. Парная + предбанник. Можем заранее протопить к вашему приезду (партнёр Иван, ~1 500 ₽). Веники, простыни — обсудим при бронировании.'
  },
  {
    id: 'arrival',
